                    ...
                    <div class="shop_order_box mt40">
                        ...
                        <div class="order_details">
                            ...
                            <div class="od_content">
                                <ul>
                                    <li class="subtitle style2 bb1 mb20 pb15"><p>Product <span class="float-right">Subtotal</span></p></li>
                                    <li class="mt20"><p>Hoodie x2 <span class="float-right">$59.00</span></p></li>
                                    <li><p>Seo Books x 1 <span class="float-right">$67.00</span></p></li>
                                    <li class="subtitle style2 bb1 mb10 mt20"><p>Subtotal <span class="float-right">$178.00</span></p></li>
                                    <li class="subtitle style2 bb1 mb20"><p>Shipping <span class="float-right totals color-orose">$178.00</span></p></li>
                                    <li class="subtitle style2"><p>Total <span class="float-right totals color-orose">$9,218.00</span></p></li>
                                </ul>
                            </div>
                        </div>
                    </div>
