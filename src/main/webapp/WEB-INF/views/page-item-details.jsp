                    ...
                    <li class="user_setting" style="margin-bottom: 1%;">
                        <div class="dropdown">
                            <a class="btn dropdown-toggle" href="#" data-toggle="dropdown"><span
                                    class="dn-1200"><%=CmmUtil.nvl(userInfo.getUserName())%><span
                                    class="fa fa-angle-down"></span></span></a>
                            <div class="dropdown-menu">
                                <div class="user_set_header">
                                    <p><%=CmmUtil.nvl(userInfo.getUserName())%><br><span
                                            class="address"><%=CmmUtil.nvl(userInfo.getUserEmail())%></span></p>
                                </div>
                    ...
                    <div class="tab-content container" id="myTabContent">
                        <div class="row mt40 tab-pane fade show active pl20 pr20" id="home" role="tabpanel"
                            ...
                            <div class="col-lg-12">
                                <div class="login_form">
                                    <p class="nav-link active" data-toggle="tab" href="#home" role="tab"
                                       aria-controls="home" aria-selected="true">User Login</p>
                                    <%-- 사용자 로그인 창 --%>
                                    <form action="/user/login" method="post">
                                        ...
                                        <a class="btn-fpswd float-right" href="#" style="margin-left: 5%">Forgot
                                            password?</a>
                        ...
                        <div class="row mt40 tab-pane fade pl20 pr20" id="profile" role="tabpanel"
                            ...
                            <div class="col-lg-12">
                                <div class="login_form">
                                    <p class="nav-link active" data-toggle="tab" href="#home" role="tab"
                                       aria-controls="home" aria-selected="true">Seller Login</p>
                                            ...
                                            <form action="/seller/login" , method="post">
                                                <div class="input-group mb-2 mr-sm-2">
                                                    <input type="text" class="form-control" id="SellerId"
                                                           placeholder="Seller Id" name="sellerId">
                                                </div>
                                                <div class="input-group form-group mb5">
                                                    <input type="password" class="form-control" id="SellerPassword"
                                                           placeholder="Seller Password" name="sellerPassword">
                                                </div>
                                                <a class="btn-fpswd float-right" href="#" style="margin-left: 5%">Forgot
                                                    password?</a>
                                                <a class="btn-fpswd float-right" href="#">Forgot id?</a>
                                                <button type="submit" class="btn btn-log btn-block btn-thm">Sign in
                                                </button>
                                                <p class="text-center mb30 mt20">Don't have an account? <a
                                                        class="text-thm" href="/regForm">Sign up</a></p>
                                            </form>
                                        </div>
                    ...
                    <div class="main-banner-wrapper home10">
                        <div class="banner-style-one owl-theme owl-carousel">
                            <div class="slide slide-one"
                                 style="background-image: url(<%=itemDto.getMainImagePath()%>);height: 650px;"></div>
                            <%
                                if (itemDto.getSubImagePath() != null) {
                            %>
                            <div class="slide slide-one"
                                 style="background-image: url(<%=itemDto.getSubImagePath()%>);height: 650px;"></div>
                            <%
                                }
                            %>
                        </div>
                    ...
                    <div class="single_property_title listing_single_v1">
                        <div class="media">
                            <div class="media-body mt20">
                                <h2 class="mt-0"><%=itemDto.getItemTitle()%>
                                </h2>
                                <ul class="mb40 agency_profile_contact listing_single_v1">
                                    <li class="list-inline-item"><a href="#"><span class="flaticon-phone"></span>
                                        +61-8181-123</a></li>
                                    <li class="list-inline-item"><a href="/user/liked/<%=itemDto.getItemSeq()%>"><span class="flaticon-pin"></span>
                                        <%
                                            if (itemDto.getIsUserLiked() == 1) {
                                        %>
                                        상품 좋아요 취소
                                        <%
                                        } else {
                                ...
                                <div class="sspd_review listing_single_v1">
                                    <ul class="mb0">
                                        ...
                                        <li class="list-inline-item text-white">
                                            (<%=CmmUtil.nvl(String.valueOf(itemReviewDtoList.size()))%> reviews)
                                        </li>
                                        <li class="list-inline-item ml20"><a class="price_range"
                                                                             href="#"><%=itemDto.getItemCount()%>개
                                            남음</a></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-xl-5">
                    <div class="single_property_social_share listing_single_v1 mt80 mt0-lg">
                        <div class="price listing_single_v1 mt25 float-right fn-lg">
                            <a href="/user/sub/<%=itemDto.getSellerId()%>/<%=itemDto.getItemSeq()%>"
                               class="btn btn-thm spr_btn">Submit Item</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 pl0 pr0 pl15-767 pr15-767">
                            <div class="listing_single_description mb60">
                                ...
                                %>
                                <p class="first-para mb25"><%=itemDto.getItemContents().substring(0, 100)%>
                                </p>
                                <p class="gpara second_para white_goverlay mt10 mb20"><%=itemDto.getItemContents().substring(100)%>
                                    ...</p>

                                <div class="collapse" id="collapseExample">
                                    <div class="card card-body">
                                        <p class="mt10 mb10"><%=itemDto.getItemContents().substring(100)%>
                                        </p>
                                    </div>
                                </div>
                                <%
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-6 col-lg-3">
                                        <div class="gallery_item">
                                            <img class="img-fluid img-circle-rounded w100"
                                                 src="<%=itemDto.getMainImagePath()%>" alt="lgs1.jpg">
                                            <div class="gallery_overlay style2"><a class="icon popup-img"
                                                                                   href="<%=itemDto.getMainImagePath()%>"><span
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-3">
                                        <div class="gallery_item">
                                            ...
                                            %>
                                            <img class="img-fluid img-circle-rounded w100"
                                                 src="<%=itemDto.getSubImagePath()%>" alt="lgs2.jpg">
                                            <div class="gallery_overlay style2"><a class="icon popup-img"
                                                                                   href="<%=itemDto.getSubImagePath()%>"><span
                                                    class="flaticon-zoom"></span></a></div>
                                            <%
                                            } else
                                            %>
                                ...
                                <div class="product_single_content mb30">
                                    ...
                                    <div class="mbp_first media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="sub_title mt-0"><%=itemReviewDto.getUserId()%>
                                            </h4>
                                            <div class="sspd_postdate fz14 mb20"><%=itemReviewDto.getReviewDate()%>
                                                <div class="sspd_review pull-right">
                                                    <ul class="mb0 pl15">
                                                        ...
                                                        %>
                                                        <li class="list-inline-item">(<%=itemReviewDto.getReviewStar()%>
                                                            )
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <p class="fz14 mt10"><%=itemReviewDto.getReviewContents()%>
                                            </p>
                                        </div>
                                    </div>
                                    <%
                                ...
                                <div class="wrapper">
                                    <form action="/user/review/<%=itemDto.getItemSeq()%>/create" , method="post">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" rows="7" placeholder="리뷰 내용"
                                                      name="reviewContents" required></textarea>
                                        </div>
                ...
                <div class="col-lg-4 col-xl-4">
                    <div class="listing_single_sidebar">
                        <div class="sidebar_pricing_widget">
                            ...
                            <ul class="mb0">
                                <li><a href="#">Price: <span
                                        class="float-right heading-color"><%=itemDto.getItemPrice()%> 원</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="feat_property">
                                <div class="thumb">
                                    ...
                                    <div class="thmb_cntnt">
                                        <ul class="tag mb0">
                                            <li class="list-inline-item"><a href="#"><%=itemDto.getItemPrice()%>원</a>
                                            </li>
                                            <li class="list-inline-item"><a href="#"><%=itemDto.getItemCount()%>개</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="details">
                                    <div class="tc_content">
                                        <h4><%=BItemDto.getItemTitle()%>
                                        </h4>
                                        <p><%=BItemDto.getItemContents().substring(0, (BItemDto.getItemContents().length() < 10 ? BItemDto.getItemContents().length() : 10))%>
                                            ...</p>
                                    </div>
                                    <div class="fp_footer">
