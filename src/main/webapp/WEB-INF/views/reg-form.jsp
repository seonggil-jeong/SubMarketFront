                    ...
                    <div class="sign_up_form inner_page">
                        <ul class="nav nav-pills mb-4" id="pills-tab2" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="pills-home-tab2" href="/regForm" role="tab"
                                   aria-controls="pills-home2" aria-selected="true">User</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="pills-profile-tab2" href="/seller/regForm" role="tab"
                                ...
                                <form action="/user/join" method="post">
                                    ...
                                    <div class="form-group input-group">
                                        <input type="password" class="form-control" id="userPassword2"
                                               name="userPassword2" placeholder="check Password" required>
                                    </div>
                                    <div class="form-group input-group">
                                    ...
                                    <div class="form-group input-group">
                                        <input type="text" class="form-control" id="userPn" name="userPn"
                                               placeholder="Pn" required>
                                    </div>
                                    <input type="button" class="btn-blue btn-thm" onclick="sample4_execDaumPostcode()"
                                           value="우편번호 찾기"><br>
                                    <div class="form-group input-group">
                                    ...
                                    <div class="form-group input-group">
                                        <input type="text" class="form-control" id="sample4_detailAddress"
                                               name="userAddress2" placeholder="Address Details">
                                    </div>
