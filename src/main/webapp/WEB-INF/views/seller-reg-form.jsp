                    ...
                    <div class="sign_up_form inner_page">
                        <ul class="nav nav-pills mb-4" id="pills-tab2" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="pills-home-tab2" href="/regForm" role="tab"
                                   aria-controls="pills-home2" aria-selected="true">User</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="pills-profile-tab2" href="/seller/regForm" role="tab"
                                   aria-controls="pills-profile" aria-selected="false">Business Owner</a>
                            </li>
                        </ul>
                                ...
                                <form action="/seller/join" method="post">
                                    ...
                                    <div class="form-group input-group">
                                        <input type="text" class="form-control" id="businessId" name="businessId"
                                               placeholder="businessId" required>
                                    </div>
                                    <div class="form-group input-group">
                                        <input type="password" class="form-control" id="sellerPassword"
                                               name="sellerPassword" placeholder="Password" required>
                                    </div>
                                    <div class="form-group input-group">
                                        <input type="password" class="form-control" id="sellerPassword2"
                                               name="sellerPassword2" placeholder="check Password" required>
                                    </div>
                                    <div class="form-group input-group">
                                    ...
                                    <div class="form-group input-group">
                                        <input type="text" class="form-control" id="sellerPn" name="sellerPn"
                                               placeholder="전화 번호" required>
                                    </div>
                                    <input type="button" class="btn-blue btn-thm" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
                                    <span id="guide" style="color:#999;display:none"></span>
                                    <div class="form-group input-group">
                                        <input type="text" class="form-control" id="sample4_roadAddress"
                                               name="sellerAddress" placeholder="Address" required>
                                    </div>
                                    <div class="form-group input-group">
                                        <input type="text" class="form-control" id="sample4_detailAddress"
                                               name="sellerAddress2" placeholder="Address Details">
                                    </div>
                                    <div class="form-group input-group">
                                        <input type="text" class="form-control" id="sellerHome" name="sellerHome"
