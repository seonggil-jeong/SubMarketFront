            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ed_menu_list mt5">
                        <ul>
                            <li><a class="active" href="/user/profile"><span class="flaticon-avatar"></span> Profile</a></li>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="my_profile_setting_input form-group mt100-500">
                                            ...
                                            <input type="text" readonly class="form-control" id="formGroupExampleInput1" name="userName" value="<%=userInfo.getUserName()%>">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="my_profile_setting_input form-group">
                                            <label for="formGroupExampleInput8">Email</label>
                                            <input type="email" class="form-control" id="formGroupExampleInput8" name="userEmail" value="<%=userInfo.getUserEmail()%>">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="my_profile_setting_input form-group">
                                            <label for="formGroupExampleEmail">Address</label>
                                            <input type="text" class="form-control" id="formGroupExampleEmail" name="userAddress" value="<%=userInfo.getUserAddress()%>">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="my_profile_setting_input form-group">
                                            <label for="formGroupExampleInput8">Address2</label>
                                            <input type="text" class="form-control" id="formGroupExampleInput9" name="userAddress2" value="<%=userInfo.getUserAddress2()%>">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xl-6">
                                        <div class="my_profile_setting_input form-group">
                                            <label for="formGroupExampleInput9">Phone</label>
                                            <input type="text" class="form-control" id="formGroupExampleInput10" name="userPn" value="<%=userInfo.getUserPn()%>">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xl-6">
                                        <div class="my_profile_setting_input form-group">
                                            <label for="formGroupExampleInput9">Age</label>
                                            <input type="text" class="form-control" id="formGroupExampleInput11" name="userAge" value="<%=userInfo.getUserAge()%>">
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
